    ...
    $( "form" ).submit(function( event ) {
        ...
        posting.done(function( data ) {
            ...
            if(data){
                ...
                alert("<?php echo get_string('sent_message', 'block_course_reports');?>");
            } else {
                alert("<?php echo get_string('not_sent_message', 'block_course_reports');?>");
            }
        });
    });
...
function createEmailForm(titulo, alunos, selected_users, courseid, other, subject) {
    ...
    $.each(alunos, function(ind, val){
        if(val){
            $.each(selected_users, function(_ind, _val){
                if(val.userid == _val.id){
                    nomes += val.nome + ", ";
                    ids.push(val.userid);
    ...
    var string =
            ...
            "<form action='email.php?id=" + courseid + "' method='post'>" +
                ...
                "<center>" +
                "<p style='font-size:small'><?php echo get_string('subject', 'block_course_reports');?>: " +
                ...
                "<?php echo get_string('lbl_ccteachers', 'block_course_reports');?>" +
                "<br>" +
                "<input type='submit' " +
                "value='<?php echo get_string('send_email', 'block_course_reports');?>' " +
